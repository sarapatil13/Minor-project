...
export default function CreateAchievementPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/achievements`, formData);
      router.push('/achievements');
      router.refresh();
    } catch (err) {
      setError(err.response?.data?.message || 'Error creating achievement');
    } finally {
      setLoading(false);
    }
  };
